  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 4px 12px rgba(0,0,0,0.08), 0 20px 48px rgba(0,0,0,0.08)',
      ...
      backgroundImage: {
        ...
        'hero-pattern':
          'radial-gradient(circle at 30% 20%, rgba(99, 102, 241, 0.08) 0%, transparent 50%), radial-gradient(circle at 70% 80%, rgba(139, 92, 246, 0.06) 0%, transparent 50%)',
        'hero-pattern-dark':
